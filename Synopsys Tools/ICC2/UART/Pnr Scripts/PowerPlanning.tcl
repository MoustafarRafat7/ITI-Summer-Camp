...
copy_block -from_block UART.dlib:UART.design -to_block PowerPlanning
...
save_block -as PowerPlanning UART.dlib:UART.design																											     VSS VDD}} \
																																		    se}} \
write_verilog   ../outputs/UART_Power_Planning_netlist.v

# --------------------------- Report --------------------------- #

report_cell >   /home/user26/Moustafa_Mohammed/Labs/Labs/UART/pnr/Reports/PP_cells.rpt
																																		     E R T I O N
report_qor  >   /home/user26/Moustafa_Mohammed/Labs/Labs/UART/pnr/Reports/PP_qor.rpt
																																		    l	   -layers {M1}     -rail_width 0.06
report_timing -max_paths 10 >   /home/user26/Moustafa_Mohammed/Labs/Labs/UART/pnr/Reports/PP_timing.rpt

report_timing -delay min -max_paths 10 >   /home/user26/Moustafa_Mohammed/Labs/Labs/UART/pnr/Reports/PP_timing_hold.rpt																	    SS} }

check_legality -verbose >  /home/user26/Moustafa_Mohammed/Labs/Labs/UART/pnr/Reports/Power_Planning_legalization.rpt

report_utilization >   /home/user26/Moustafa_Mohammed/Labs/Labs/UART/pnr/Reports/Power_Planning_legallization.rpt
